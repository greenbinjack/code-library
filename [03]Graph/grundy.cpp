/* single pile game-> greedy or game dp multiple pile game and disjunctive(before playing, choose 1 pile) -> NIM game
...
if XOR(grundy(games)) == 0: losing state else winning state */
vector<int> moves, dp;
